...
set in1=../src/app/app_module.cpp ../src/network/znet_module.cpp ../src/common/com_module.cpp
set in2=../src/app/app_textures.cpp
...
@echo on
@cl %compilerFlags% %compilerDefines% /LD %in1% %in2% %compOut% %linkInput%
