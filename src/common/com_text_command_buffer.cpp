...
i32 COM_EnqueueTextCommand(char* command, char* buffer, i32 position, i32 capacity)
{
...
i32 COM_DequeueTextCommand(char* buffer, char* target, i32 position, i32 targetCapacity)
{
