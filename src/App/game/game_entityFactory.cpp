...
Ent* Spawn_WorldCube(GameState* gs, Cmd_Spawn* cmd)
{
    ...
    RendObj_SetAsMesh(&renderer->rendObj, &g_meshCube, 1, 1, 1, AppGetTextureIndexByName("COMP03_1.bmp"));
...
Ent* Spawn_GroundActor(GameState* gs, Cmd_Spawn* cmd)
{
    ...
    RendObj_SetAsBillboard(&renderer->rendObj, 1, 1, 1, AppGetTextureIndexByName("brbrick2.bmp"));
